...
- The core components should already be familiar to any MLE with a working knowledge of transformers. (Variational autoencoders are the one exception, but they deserve their own dedicated deep dive).
